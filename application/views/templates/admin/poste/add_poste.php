        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                           <strong class="card-title">Gerer les postes</strong><br>
             ...
             <?php $this->load->view('page/admin/poste/table') ?>  
               ...
               <div class="login-content">
                 <div class="login-form">
                                <form action="<?php echo base_url('admin/admin/submit_poste')?>" method="POST">

                                    <div class="form-group">
                                        <label for="nom"><strong>Nom poste</strong><i style="color: red;">*</i></label>
                                        <input type="text" name="nom_poste" class="form-control" class="form-control" required>
                                    </div>
